                      ...
                      <form class="form-inline my-2 my-lg-0 mr-auto">
                        ...
                        <button class="btn btn-outline-light my-2 my-sm-0" type="submit">Go!</button>
                         ...
                         <ul class="navbar-nav right">
                               <li class="nav-item">
                                 <a id="Login" class="nav-link" href="login.html
                                 ">
...
%>
    ...
    <!--Content  -->
    <div id=content class="container-fluid marg">
            <form method="post" action="register">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" pattern="[0-9]{10}" title="10 digit mobile number" placeholder="Phone">
                      </div>
                      <div class="form-group col-md-6">
